...
object ChangelogRegistry {
    ...
    private val changelogs = listOf<ChangelogEntry>(
        ChangelogEntry(
            versionCode = 37,
            versionName = "1.12.0",
            changes = listOf(R.string.changelog_v1_12_0_item1)
        ),
        ChangelogEntry(
            versionCode = 36,
            versionName = "1.11.0",
            changes = listOf(
                R.string.changelog_v1_11_0_item1
            )
        ),
        ChangelogEntry(
            versionCode = 35,
            versionName = "1.10.1",
            changes = listOf(
                R.string.changelog_v1_10_1_item1
            )
        ),
        ChangelogEntry(
            versionCode = 34,
            versionName = "1.10.0",
            changes = listOf(
                R.string.changelog_v1_10_0_item1
            )
        ),
        ChangelogEntry(
            versionCode = 33,
            versionName = "1.9.0",
            changes = listOf(
                R.string.changelog_v1_9_0_item1
            )
        ),
        ChangelogEntry(
            versionCode = 32,
            versionName = "1.8.2",
            changes = listOf(
                R.string.changelog_v1_8_2_item1,
                R.string.changelog_v1_8_2_item2,
                R.string.changelog_v1_8_2_item3
            )
        ),
        ChangelogEntry(
            versionCode = 31,
            versionName = "1.8.1",
            changes = listOf(
                R.string.changelog_v1_8_1_item1
            )
        ),
        ChangelogEntry(
            versionCode = 30,
